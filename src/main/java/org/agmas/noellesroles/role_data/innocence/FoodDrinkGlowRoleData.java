...
public class FoodDrinkGlowRoleData extends SimpleRoleData {
    //
    ...
    public static void playerDrink(Player p, ItemStack item) {
        ...
        for (var p2 : p.level().players()) {
            if (gameWorldComponent.isRole(p2, ModRoles.BARTENDER)) {
                FoodDrinkGlowRoleData data = RoleData.getNullable(FoodDrinkGlowRoleData.class, p2);
    ...
    public FoodDrinkGlowRoleData(RoleDataContext context) {
        super(context);
    }
