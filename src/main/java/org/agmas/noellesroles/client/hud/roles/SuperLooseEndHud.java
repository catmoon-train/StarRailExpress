    ...
    public static void register() {
        RoleHudRenderCallback.EVENT.register(SpecialGameModeRoles.SUPER_LOOSE_END.identifier(), (guiGraphics, deltaTracker) -> {
            ...
            guiGraphics.drawString(font, armorText, 10, yOffset - font.lineHeight - 4,
                    Color.WHITE.getRGB());
            // 渲染技能状态
            SuperLooseEndRoleData superLooseEndPlayerComponent = RoleData.getNullable(SuperLooseEndRoleData.class, client.player);
            if (superLooseEndPlayerComponent == null) return;
            // 渲染位置 - 右下角
