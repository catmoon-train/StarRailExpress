...
public class ModRoles {
    ...
    static {
        ...
        GUEST_GHOST.setAddedVersion("4.2");
        MA_CHEN_XU.setAddedVersion("4.2");
        DIO.setAddedVersion("3.3");
        JOJO.setAddedVersion("3.3");
        EXAMPLER.setAddedVersion("3.2");
        LOCKSMITH.setAddedVersion("3.2");
        ...
        DIVER.setAddedVersion("4.2");
        SWAST.setAddedVersion("3.3");
        MARTIAL_ARTS_INSTRUCTOR.setAddedVersion("3.3");
        SEA_KING.setAddedVersion("4.2");
        WATER_GHOST.setAddedVersion("4.2");
