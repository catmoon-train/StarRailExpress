...
public class TMMRoles {
    ...
    public static final Role DISCOVERY_CIVILIAN = registerRole(
            new NoramlRole(SRE.id("discovery_civilian"), 0x36E51B, true, false, Role.MoodType.NONE, -1, true));
    public static final Role CIVILIAN = registerRole(new NoramlRole(SRE.id("civilian"), 0x36E51B, true, false,
            Role.MoodType.REAL, GameConstants.getInTicks(0, 10), false));
    public static final Role VIGILANTE = registerRole(new NoramlRole(SRE.id("vigilante"), 0x1B8AE5, true, false,
