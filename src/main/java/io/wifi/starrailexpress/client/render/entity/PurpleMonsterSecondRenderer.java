...
public class PurpleMonsterSecondRenderer extends MobRenderer<PurpleMonsterSecondEntity, PurpleMonsterSecondModel> {
    ...
    public PurpleMonsterSecondRenderer(EntityRendererProvider.Context context) {
        super(context, new PurpleMonsterSecondModel(context.bakeLayer(PurpleMonsterSecondModel.LAYER_LOCATION)), 0.7F);
    ...
    @Override
    protected void renderNameTag(PurpleMonsterSecondEntity entity, Component component, PoseStack poseStack,
